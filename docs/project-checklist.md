...
| NFR-P01 | 95% API responses <400ms | ✅ | Caching, indexed queries |
...
| Booking | ✅ | Resource list, reservation creation |
| Marketplace | ✅ | Product list, cart, checkout, product creation |
| Exams | ✅ | Exam creation, start, submission |
| Dashboard | ✅ | Live sensors, shuttle position |
